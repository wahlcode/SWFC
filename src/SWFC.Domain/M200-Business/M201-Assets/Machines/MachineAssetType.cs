...
public sealed class MachineAssetType
{
    private MachineAssetType(string value)
    {
        Value = value;
    }
    ...
    public static MachineAssetType Create(string? value)
    {
        ...
        return new MachineAssetType(normalized);
    }
