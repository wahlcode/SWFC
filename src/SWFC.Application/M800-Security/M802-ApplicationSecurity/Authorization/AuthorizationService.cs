...
public sealed class AuthorizationService : IAuthorizationService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        foreach (var role in requirement.RequiredRoles)
        {
            ...
            {
                return Task.FromResult(AuthorizationResult.Forbidden($"Missing required role: {role}."));
            }
        }
        ...
        foreach (var permission in requirement.RequiredPermissions)
        {
            ...
            {
                return Task.FromResult(AuthorizationResult.Forbidden($"Missing required permission: {permission}."));
            }
        }
