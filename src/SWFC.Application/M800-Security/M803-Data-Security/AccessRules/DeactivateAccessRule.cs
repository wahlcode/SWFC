...
public sealed record DeactivateAccessRuleCommand(
    Guid Id,
    string Reason);

public sealed class DeactivateAccessRuleValidator : ICommandValidator<DeactivateAccessRuleCommand>
{
    public Task<ValidationResult> ValidateAsync(
        DeactivateAccessRuleCommand command,
...
public sealed class DeactivateAccessRulePolicy : IAuthorizationPolicy<DeactivateAccessRuleCommand>
{
    public AuthorizationRequirement GetRequirement(DeactivateAccessRuleCommand request)
        => new(requiredPermissions: new[] { "machine.update" });
}

public sealed class DeactivateAccessRuleHandler : IUseCaseHandler<DeactivateAccessRuleCommand, bool>
{
    private readonly ICurrentUserService _currentUserService;
    private readonly IAccessRuleWriteRepository _writeRepository;
    private readonly IAuditService _auditService;

    public DeactivateAccessRuleHandler(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        _writeRepository.Deactivate(rule, changeContext);
